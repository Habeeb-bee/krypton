...
const Footer = () => {
  ...
  <div className="container mx-auto ">
    <div className="grid grid-cols-2 gap-8 mb-[2em] tablet:grid-cols-2 laptop:grid-cols-5">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="https://chat.whatsapp.com/HnnuYN7tfwXE6fR6TF8f3A" className="text-gray-400 hover:text-white">WhatsApp</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="https://x.com/ha90094?s=09" className="text-gray-400 hover:text-white">Twitter</a></li>
          <li><a href="https://wa.me/qr/HNITN35X4YHEG1" className="text-gray-400 hover:text-white">WhatsApp</a></li>
        </ul>
      </div>
    </div>
    ...
    <div className="mt-5 text-center text-gray-500">
      <p>&copy; 2024 Krypton. All rights reserved.</p>
    </div>
  </div>
</footer>
